...
<div class="jumbotron text-center">
    ...
    <a class="btn btn-default" href="?pagina=cadastrarUsuario&id=<?php echo $id_usuario; ?>">Editar</a>
    <a class="btn btn-default" href="excluir_usuario.php?id=<?php echo $id_usuario; ?>">Excluir</a>
</div>
</div>